  ...
  const loader = (
    <div className="relative" role="status" aria-label="Loading">
      ...
      >
        ...
        <div className="absolute inset-0 rounded-full border-4 border-transparent border-t-pink-400 border-r-cyan-400 border-b-purple-400 border-l-cyan-400 animate-spin" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }} />
